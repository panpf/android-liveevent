...
class DefaultValueLiveEventTest {
    ...
    fun test() {
        ...
        Assert.assertEquals("listenForeverStickyValue test error", 88, fragment.listenForeverStickyValue)
    ...
    class TestViewModel : ViewModel() {
        val testLiveEvent = LiveEvent(88)
    }
